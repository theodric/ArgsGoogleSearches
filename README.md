...
v1.2 adds the ability to toggle adding the `&udm=14` parameter to the search URL in order to further nerf the creeping AI. (Thanks to the person on Mastodon who made me aware of this, and who I will happily credit if they wish!) [Read more about udm=14 here](https://tedium.co/2024/05/17/google-web-search-make-default/).  
v1.2 has also been opened up to Firefox for Android. The UX is trash on mobile, but it does work. Pull requests welcome :)
